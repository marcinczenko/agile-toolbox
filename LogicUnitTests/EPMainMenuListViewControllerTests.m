//
//  EPMainMenuListViewControllerTests.m
//  AgileToolbox
//
...
@interface EPMainMenuListViewControllerTests : XCTestCase

@property (nonatomic,strong) EPMainMenuListViewController* viewController;
...
@implementation EPMainMenuListViewControllerTests
...
- (void) setUp
{
    self.viewController = [[EPMainMenuListViewController alloc] init];
}
...
{
    XCTAssertEqual(1,(int)[self.viewController numberOfSectionsInTableView:self.doesNotMatter],@"Wrong number of sections returned!");
}
