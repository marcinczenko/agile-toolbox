...
#import "EPTopicDetailsViewController.h"

@interface EPTopicsListViewController ()

@property(nonatomic, strong) NSMutableArray *topics;

@end

@implementation EPTopicsListViewController
...
- (void)viewDidLoad
{
    ...
    self.view.accessibilityLabel = @"Topics";
